...
public class RestClient {
    ...
    private RestClient() {
        ...
        OkHttpClient build = new OkHttpClient.Builder().readTimeout(2, TimeUnit.MINUTES).connectTimeout(2, TimeUnit.MINUTES).writeTimeout(2, TimeUnit.MINUTES).addInterceptor(new Interceptor() {
            /* class bane.instadownloader.videodownload.api.$$Lambda$RestClient$5aOt8Q2mVYy9M611GNNIrkbFI */
    ...
    public /* synthetic */ Response lambda$new$0$RestClient(Interceptor.Chain chain) throws IOException {
