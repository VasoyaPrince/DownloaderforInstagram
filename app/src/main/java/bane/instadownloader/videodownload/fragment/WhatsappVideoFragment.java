...
public class WhatsappVideoFragment extends Fragment {
    ...
    private void initViews() {
        ...
        this.binding.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            /* class bane.instadownloader.videodownload.fragment.$$Lambda$WhatsappVideoFragment$UWpJ9HUENx7iiJiEYtL_g84nzRc */

            @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
            public final void onRefresh() {
                WhatsappVideoFragment.this.lambda$initViews$0$WhatsappVideoFragment();
            }
        });
    }

    public /* synthetic */ void lambda$initViews$0$WhatsappVideoFragment() {
        this.statusModelArrayList = new ArrayList<>();
        getData();
    ...
    private void getData() {
        ...
        try {
            Arrays.sort(this.allfiles, $$Lambda$WhatsappVideoFragment$Sld9RvVpeMAaF1tc_bVIquE0H0.INSTANCE);
            int i = 0;
            while (true) {
        ...
        Arrays.sort(listFiles, $$Lambda$WhatsappVideoFragment$gwjuunEFH2TxHeXoK4g8pC8EqO8.INSTANCE);
