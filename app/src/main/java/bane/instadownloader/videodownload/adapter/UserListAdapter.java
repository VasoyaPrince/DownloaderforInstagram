...
import bane.instadownloader.videodownload.databinding.ItemUserListBinding;
import bane.instadownloader.videodownload.interfaces.UserListInterface;
import bane.instadownloader.videodownload.model.story.TrayModel;
...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        Glide.with(this.context).load(this.trayModelArrayList.get(i).getUser().getProfile_pic_url()).thumbnail(0.2f).into(viewHolder.binding.storyPc);
        viewHolder.binding.RLStoryLayout.setOnClickListener(new View.OnClickListener() {
            /* class bane.instadownloader.videodownload.adapter.UserListAdapter.AnonymousClass1 */
